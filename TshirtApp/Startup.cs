...
namespace TshirtApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=DESKTOP-DMGK25P;Database=TshirtApp;Trusted_Connection=True;";
            services.AddDbContext<TshirtDbContext>(options => options.UseSqlServer(connection));
